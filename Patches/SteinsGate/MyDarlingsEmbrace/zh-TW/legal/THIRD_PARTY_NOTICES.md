...
Original *STEINS;GATE* game materials and official localized text are not third-party open-source dependencies of this repository and are not relicensed by the notices above. Their rights remain with their respective rights holders. See [`NOTICE.md`](NOTICE.md).
